...
@property (nonatomic, retain) UIImage *decodeImage;
...
//- (void)zxingController:(ZXingWidgetController*)controller didScanResult:(NSString *)result diDecodeImage:(UIImage*)image;
